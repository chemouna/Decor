...
for Gradle:
```groovy
compile 'com.mounacheikhna:decor:0.2.2'
compile 'com.mounacheikhna:decorators:0.2.2'
```
...
```xml
<dependency org="com.mounacheikhna" name="decor" rev="0.2.2" />
<dependency org="com.mounacheikhna" name="decorators" rev="0.2.2" />
```
