package mona.android.decor.app.test;
...
import mona.android.decor.app.CreatesFragActivity;
...
public class FragmentsTest {
	...
	public void testCreatesFragActivity() throws Exception {
		...
		assertThat(activity.findViewById(mona.android.decor.app.R.id.line1)).isNotNull();
	}
}
