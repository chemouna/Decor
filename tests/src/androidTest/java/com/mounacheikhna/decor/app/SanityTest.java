...
public class SanityTest {
    ...
    public void testSanity() throws Exception {
        ...
        assertThat(context.getPackageName()).isEqualTo("com.mounacheikhna.decor.app.test");
    }
    ...
    public void testWrapActivity() throws Exception {
        ...
        intent.setComponent(new ComponentName("com.mounacheikhna.decor.app", "TestActivity"));
